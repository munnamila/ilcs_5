...
def keypoints_from_images(src, tgt_imgs, tgt_points):
    try:
        ...
        for imagePath in tqdm(imagePaths):
            ...
            np.savez(tgt_points + '/' + '%06d' % count + '.npz', pose = datum.poseKeypoints)
...
if __name__ == '__main__':
    keypoints_from_images('/home/flowerdance/openpose/examples/media/video/murase/video_1',
     '/home/flowerdance/openpose/examples/media/video/murase/video_2', 
     '/home/flowerdance/openpose/examples/media/video/murase/data')
